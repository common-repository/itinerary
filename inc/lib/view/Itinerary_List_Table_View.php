...
/**
 * Clone the WP Table class so we can ensure that it won't randomly disappear on us*
 * User: michael
 * Date: 3/8/17
 * Time: 8:06 PM
 */
...
class Itinerary_List_Table_View {
    /**
    ...
    function print_column_headers($with_id = true) {
        ...
        if (isset($_GET['orderby']))
            $current_orderby = filter_var(INPUT_GET, 'orderby', FILTER_SANITIZE_STRING);
        else
            $current_orderby = '';
